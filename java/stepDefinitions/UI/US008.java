...
public class US008 {
    ...
    public void S2kullaniciLoginOlur() {
        ...
        page.signIn.click();
        page.usernameBox.sendKeys(ConfigReader.getProperty("userUsernameS"));
        page.passwordBox.sendKeys(ConfigReader.getProperty("userPasswordS"));
    ...
    public void S2kullaniciAccountMenudenPasswordLinkTiklar() {
        ...
        ReusableMethods.jsScrollClick(page.accountMenu);
        ReusableMethods.jsScrollClick(page.passwordLink);
    }

    @And("S2 kullanici current password girer")
    public void S2kullaniciCurrentPasswordGirer() {

        page.currentPasswordBox.sendKeys(ConfigReader.getProperty("userPasswordS"));
    }

    @And("S2 kullanici new password girer")
    public void S2kullaniciNewPasswordGirer() {

        page.newPasswordBox.sendKeys(ConfigReader.getProperty("userPasswordS"));
    }

    @And("S2 kullanici new password confirmation girer")
    public void S2kullaniciNewPasswordConfirmationGirer() {

        page.confirmPasswordBox.sendKeys(ConfigReader.getProperty("userPasswordS"));
    }
    ...
    public void S2kullaniciLoginOlupAccountMenudenPasswordLinkeTiklar() throws IOException {
        ...
        page.signIn.click();
        ReusableMethods.waitFor(2);
        page.usernameBox.sendKeys(ConfigReader.getProperty("excelUsernameS"));
        ReusableMethods.waitFor(2);
    ...
    public void S2kullaniciCurrentPassworduGirerVeNewPasswordVeConfirmPasswordEEskiSifreyiGirer() throws IOException {
        ...
        //write
        workbook.getSheet("Sayfa1").getRow(0).createCell(0).setCellValue(eskiSifre);
        workbook.getSheet("Sayfa1").getRow(1).createCell(0).setCellValue(gecerliSifre);
        fos = new FileOutputStream(filePath);
        workbook.write(fos);
